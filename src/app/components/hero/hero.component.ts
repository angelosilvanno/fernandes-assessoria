        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div class="lg:col-span-7 space-y-6">
            <span class="inline-block px-3.5 py-1 text-xs font-semibold tracking-wider text-gold border border-gold/40 rounded-full uppercase bg-gold/10">
              Upanema / RN e Municípios da Região
            </span>
            ...
            <p class="text-slate-300 text-base sm:text-lg max-w-xl font-normal leading-relaxed">
              Especialistas em prestações de contas governamentais (SIOPE, SIOPS, Caixa Escolar), planejamento orçamentário municipal e programas da Saúde, Educação e Assistência.
            </p>
          ...
          <div class="lg:col-span-5 relative flex justify-center">
            <div class="relative w-full max-w-md">
              <img 
                ...
                alt="Assessoria e Gestão Pública Municipal" 
              ...
              <div class="absolute -bottom-6 -left-6 bg-white text-navy p-5 rounded-xl shadow-2xl border-l-4 border-gold">
                ...
                <span class="text-xs font-semibold text-slate-500 uppercase tracking-wide">De Experiência em Gestão</span>
              </div>
            </div>
          </div>
